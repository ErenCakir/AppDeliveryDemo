...
extension DeveloperToolsSupport.ImageResource {
    ...
    static let marketLogo = DeveloperToolsSupport.ImageResource(name: "marketLogo", bundle: resourceBundle)

    /// The "yemekLogo" asset catalog image resource.
    static let yemekLogo = DeveloperToolsSupport.ImageResource(name: "yemekLogo", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "marketLogo" asset catalog image.
    static var marketLogo: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .marketLogo)
#else
        .init()
#endif
    }

    /// The "yemekLogo" asset catalog image.
    static var yemekLogo: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .yemekLogo)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "marketLogo" asset catalog image.
    static var marketLogo: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .marketLogo)
#else
        .init()
    ...
    /// The "yemekLogo" asset catalog image.
    static var yemekLogo: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .yemekLogo)
#else
        .init()
